...
|---|---|
|`list* List_new(void)`|Crea a inicializa una lista sin elementos creando un nodo `dummy` el cual es asociado al `head` de la lista|
...
|`void List_clean(void)`|Vacia una lista enlazada|
